  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Stay updated with the latest from your sports community.',
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          Row(children: [
            // Quick action chips
            _QuickActionChip(icon: Icons.image_outlined, label: 'Photo / Video'),
            const SizedBox(width: 8),
            _QuickActionChip(
                icon: Icons.emoji_events_outlined, label: 'Tournament'),
            const SizedBox(width: 8),
            _QuickActionChip(
                icon: Icons.scoreboard_outlined, label: 'Match Result'),
            const Spacer(),
            // Post button
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(widget.label, style: _t(size: 12, color: color,
              weight: FontWeight.w600)),
        ]),
      ),
    );
...
class _RightSidebar extends StatelessWidget {
  static const _trending = [
    ('Football', '⚽', '1,284 posts'),
    ('Basketball', '🏀', '876 posts'),
    ('Cricket', '🏏', '642 posts'),
    ('Badminton', '🏸', '421 posts'),
    ('Tennis', '🎾', '318 posts'),
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: _trending.asMap().entries.map((e) {
                  final (sport, emoji, count) = e.value;
            ...
            ListenableBuilder(
              ...
              builder: (context, _) {
                // Show placeholder events — replace with real data when events
                // collection is added to Firebase
                return _EventsPlaceholder();
              },
            ),
          ],
        ),
