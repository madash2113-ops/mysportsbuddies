  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(_mode == _SportMode.individual
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_mode != _SportMode.individual) ...[
                    _label(_mode == _SportMode.pair ? 'Pair Name (optional)' : 'Team Name'),
                    _field(
                      _teamNameCtrl,
                      _mode == _SportMode.pair
                          ? 'e.g. Dynamic Duo'
                  ...
                  // ── Phone ──
                  _label(_mode == _SportMode.individual
                  ...
                  Row(children: [
                    Text(
                      _mode == _SportMode.individual ? 'Your Profile'
                        : _mode == _SportMode.pair   ? 'Players'
                        : 'Squad',
                  ...
                  if (_mode == _SportMode.team) ...[
                    ...
                    Row(children: [
                      ...
                      Icon(Icons.star_half_rounded,
                          color: const Color(0xFFB0C4DE), size: 13),
                      const SizedBox(width: 4),
                  ...
                  if (totalFee > 0) ...[
                    Container(
                      ...
                      child: Column(children: [
                        _feeRow('Entry Fee', '₹${widget.entryFee.toInt()}'),
                        const SizedBox(height: 6),
                        _feeRow('Service Fee', '₹${widget.serviceFee.toInt()}'),
                        const Divider(color: Colors.white12, height: 16),
                        _feeRow('Total', '₹${totalFee.toInt()}', bold: true),
                      ]),
                    ),
                    const SizedBox(height: 6),
                    const Text(
